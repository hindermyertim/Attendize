...
<script type="text/javascript">
        ...
        $("#contactUsSubmit").click(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    messagebody: $("#message_contact").val()
                },
                success: function(result) {
                    console.log(result);
                    if (result.errors === false) {
                        $('#contactResult').text('Your email has been sent, we will contact you shortly.');
                    } else {
                        $('#contactResult').text('Email Fail\'d, donno why but try emailing us at contact@leftrite.com');
                    }
                },
    ...
    (function($) {
        ...
        $.latitude_longitude = [
            [40.67, -73.940]
        ]; //-- google map latitude and longitude, $.latitude_longitude = [[latitude,longitude]];
        $.map_marker_url = "{{ Theme::url('img/marker.png') }}";
        ...
        $(window).load(function(e) {
            ...
            var show_home = setTimeout(function() {
                ...
                $("#wordsrotator").wordsrotator({
                    ...
                    speed: 9000, //-- delay in milliseconds between two words
                    words: ['empowering Philadelphia\'s dance music community',
                        'one night at a time'
        ...
        $(document).ready(function(e) {
                ...
                if (!$('.subscribe-email, .contact-name, .contact-email, .contact-message').is(':focus')) {
                    ...
                    if (e.which == 37) {
                        ...
                        if (active_nav == "nav-home") {
                            ...
                            $('nav a.nav-events').trigger('click');
                        } else if (active_nav == "nav-events") {
            ...
            $('.twitter-feed').twittie({
                ...
                //added 's to line 448, those double brackets were fuckin with blade, prob bork'd twitte but we'll see...
                count: 10,
                    ...
                    $.ajax({
                        ...
                        error: function(err) {
                            ...
                            $('.loading-subscribe').fadeOut('fast', function() {
                                //-- show notif
                                $('.subscribe-notif').append('<label class="subscribe-notif-error">There was an issue with your submission, you are probably already registered, ya dingus.</label>');
                                $('.subscribe-notif-error').fadeIn('fast').delay(10000).fadeOut('fast', function() {
                                    $(this).remove();
                        ...
                        success: function(result) {
                            if (result.errors === false) {
                                ...
                                $('.loading-subscribe').fadeOut('fast', function() {
                                    //-- show notif
                                    $('.subscribe-notif').append('<label class="subscribe-notif-success">Thank you for subscribing, please check your email to confirm.</label>');
                                    $('.subscribe-notif-success').fadeIn('fast').delay(10000).fadeOut('fast', function() {
                                        $(this).remove();
                                        $('.loading-subscribe').remove();
                                    });
                                });
