...
class LedgerHelper {
    ...
    public static function record(array $data, BalanceAccount $account)
    {
    ...
    public static function accountStats(BalanceAccount $account){
        $static = (new static);
        return ['ledger' => $account->ledgers()->get(), 'summary' => $static->summary($account), 'transactions'=>$static->transactions($account)];
    }

    public static function transactions(BalanceAccount $account)
    {
    ...
    public static function summary(BalanceAccount $account){
